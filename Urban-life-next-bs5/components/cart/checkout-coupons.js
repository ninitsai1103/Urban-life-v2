...
export default function CheckoutCouponsSelect({ coupons, sendSelectedCoupon }) {
  ...
  const handleNoCouponSelected = () => {
    ...
    // sendSelectedCoupon({"id":1,"user_id":43,"coupon_id":1,"valid":1,"name":"註冊優惠券","code":"VIP666","amount":0,"started_at":"2024-04-24","deadline":"2024-05-31","created_at":"2024-01-01 00:00:00","updated_at":"2024-01-19 00:00:00","status":"可使用","min_price":500,"condition":"資材"})
